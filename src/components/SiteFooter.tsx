export function SiteFooter() {
  return (
    <footer className="mt-8 border-t border-white/5 pt-6 text-center">
      <p className="text-xs text-gray-500">Built by Andrew Cai</p>
      <p className="mt-1 text-[10px] tracking-wide text-gray-600">
        AI × Poker × Personality
      </p>
      <div className="mt-3 flex items-center justify-center gap-3">
        <a
          href="https://github.com/andrew-cai-ai"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="GitHub profile"
          className="rounded p-1 text-gray-400 opacity-40 transition-all duration-200 hover:scale-110 hover:text-casino-gold/90 hover:opacity-100"
        >
          <svg
        ...
        <a
          href="https://www.linkedin.com/in/andrew-cai-666b4b171/"
          target="_blank"
          rel="noopener noreferrer"
